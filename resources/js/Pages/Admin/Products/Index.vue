...
<template>
    <AdminLayout>
        <div class="flex justify-between items-center mb-10">
            <h1 class="font-serif text-4xl text-[#1C1C1C]">商品管理</h1>
        ...
        <div class="bg-white border border-gray-100">
            ...
            <div v-for="product in products.data" :key="product.id"
                ...
                <div class="col-span-4">
                    <p class="font-medium text-sm text-[#1C1C1C]">{{ product.name }}</p>
                ...
                <div class="col-span-2 flex justify-end gap-4">
                    <Link :href="route('admin.products.edit', product.id)"
                        class="text-xs text-gray-400 hover:text-[#1C1C1C] transition">編輯</Link>
                    <button @click="destroy(product.id)"
                        class="text-xs text-gray-400 hover:text-red-500 transition">刪除</button>
                </div>
            </div>
