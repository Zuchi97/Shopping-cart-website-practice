...
<template>
    <AdminLayout>
        <div class="max-w-2xl">
            ...
            <form @submit.prevent="submit" class="bg-white border border-gray-100 p-8 space-y-8">
                <div>
                    <label class="block text-xs tracking-widest uppercase text-gray-400 mb-3">商品名稱</label>
                    <input v-model="form.name" type="text"
                        class="w-full border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#1C1C1C] transition bg-transparent"
                        placeholder="輸入商品名稱">
                ...
                <div>
                    ...
                    <textarea v-model="form.description" rows="4"
                        class="w-full border border-gray-200 px-4 py-3 text-sm focus:outline-none focus:border-[#1C1C1C] transition bg-transparent resize-none"
